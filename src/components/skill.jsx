      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div data-aos="fade-right">
            <h3 className="text-lg sm:text-xl font-semibold mb-6 text-gray-700">Technical Skills</h3>
          ...
          <div data-aos="fade-left">
            <h3 className="text-lg sm:text-xl font-semibold mb-6 text-gray-700">Professional Skills</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {[
                ...
                <div key={skill.title} className="bg-white p-4 sm:p-6 rounded-lg shadow-sm border-l-4 border-indigo-600">
                  <div className="flex items-center mb-2 sm:mb-3">
                    <div className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center mr-3">
                      {skill.icon}
                    </div>
                    <h4 className="font-medium text-sm sm:text-base">{skill.title}</h4>
                  </div>
        ...
        <div className="mt-12 sm:mt-16" data-aos="fade-up">
          <h3 className="text-lg sm:text-xl font-semibold mb-6 text-center text-gray-700">Tools & Technologies</h3>
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
            {[
              ...
              <div key={tool.alt} className="w-12 h-12 sm:w-16 sm:h-16 bg-white rounded-full shadow-sm flex items-center justify-center">
                <img src={tool.src} alt={tool.alt} className="w-6 sm:w-8" />
              </div>
            ))}
          </div>
        </div>
